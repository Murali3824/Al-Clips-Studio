...
def run(context):
    ...
    for highlight in highlights:
        ...
        metadata = {
            ...
            "hookText": meta_res.get("hookText", meta_res["hook"]),
            "userHookText": meta_res.get("userHookText"),
            "hook": meta_res["hook"],
            ...
            "metadataQualityScore": meta_res.get("metadataQualityScore", meta_res.get("qualityScore")),
